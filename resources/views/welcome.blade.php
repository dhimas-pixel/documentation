                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="{{ route('todolist.index') }}"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Notify Module</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Modul ini membahas pengujian Laravel dengan Pusher dan Node.js menggunakan Socket.IO
                                untuk komunikasi real-time, termasuk integrasi dan metode testing untuk memastikan
                                kestabilan sistem.
                            </p>
                        </div>
